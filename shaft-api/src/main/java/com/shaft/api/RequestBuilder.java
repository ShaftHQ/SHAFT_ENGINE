...
public class RequestBuilder {
    ...
    public ApiSession performRequest() {
        ...
        try {
            ...
            if (com.shaft.properties.internal.Properties.performance.isEnablePerformanceReport()) {
        ...
        ApiSession driver = session.getDriver();
        if (driver == null) {
            driver = new ApiSession(session);
