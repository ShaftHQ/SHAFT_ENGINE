...
import com.shaft.api.ApiSession;
...
public class RequestBuilderTests {
    ...
    public void performRequestShouldCreateDriverAndStorePerformanceDataWhenDriverIsMissing() {
        ...
        ApiSession driver = new RequestBuilder(mockSession, "users/123/", RestActions.RequestType.GET).performRequest();
        ...
        Mockito.verify(mockSession).setDriver(Mockito.any(ApiSession.class));
    }
    ...
    public void performRequestShouldReturnExistingDriverWhenSessionDriverExists() {
        ...
        RequestSpecification specs = Mockito.mock(RequestSpecification.class, Mockito.RETURNS_DEEP_STUBS);
        Response response = Mockito.mock(Response.class);
        ApiSession existingDriver = Mockito.mock(ApiSession.class);
        ...
        ApiSession returnedDriver = new RequestBuilder(mockSession, "users", RestActions.RequestType.GET).perform();
    ...
    private RequestSpecification prepareSuccessfulPerformRequestMocks(RestActions mockSession, String serviceName,
        ...
        Mockito.when(mockSession.getDriver()).thenReturn(Mockito.mock(ApiSession.class));
        return specs;
    }
}
