...
pull request -> babysit (fix review comments, failed tests, and unresolved threads, then resolve them) to green -> prove epic and tracker initial scope is complete -> merge ->
