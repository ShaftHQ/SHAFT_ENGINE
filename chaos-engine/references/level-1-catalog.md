...
| FreeToken | Optional standalone local MoE companion (`:1919`); never CE-installed; not OmniRoute | [`../skills/freetoken/SKILL.md`](../skills/freetoken/SKILL.md) · guide (repo-only `chaos-engine/guides/freetoken.md`) |
| Colibri | Optional frontier MoE multitier companion (`:8000`); never CE-installed; peer to FreeToken | [`../skills/colibri/SKILL.md`](../skills/colibri/SKILL.md) · guide (repo-only `chaos-engine/guides/colibri.md`) |
| Local OpenAI-compat | Optional Ollama / LM Studio / llamacpp OpenAI-compat peers; never CE-installed; not OmniRoute/FreeToken plugins | [`../skills/local-openai-compat/SKILL.md`](../skills/local-openai-compat/SKILL.md) · guide (repo-only `chaos-engine/guides/local-openai-compat.md`) |
