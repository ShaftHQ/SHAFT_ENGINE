...
| datetime | Portable runtime standard-library dependency. | chaos-engine/deep_research.py, chaos-engine/dependencies.py, chaos-engine/hooks/reflection.py, chaos-engine/learn_traces.py, chaos-engine/learn_traces_mrv.py, chaos-engine/skills/omniroute/scripts/runner.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
