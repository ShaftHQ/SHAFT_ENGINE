...
| re | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/dependencies.py, chaos-engine/grok_lean_config.py, chaos-engine/heuristics.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/kernel.py, chaos-engine/hooks/reflection.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learn_traces.py, chaos-engine/learn_traces_mrv.py, chaos-engine/learning.py, chaos-engine/mcp_policy.py, chaos-engine/overlay_match.py, chaos-engine/phase_ledger.py, chaos-engine/retrieve.py, chaos-engine/session_token_usage.py, chaos-engine/significance.py, chaos-engine/skill_compress_audit.py, chaos-engine/skills/local-agency/scripts/design_turn_gate.py, chaos-engine/skills/omniroute/scripts/runner.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| shlex | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/hooks/guard.py, chaos-engine/skills/omniroute/scripts/runner.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
