...
default; repository-specific distributions in the
[distribution catalog](distributions.json) require an explicit selection.
...
| --- | --- | --- | --- |
| OmniRoute | [skill](skills/local-runtimes/references/omniroute.md) · [guide](guides/omniroute.md) | [OmniRoute docs / guides](https://github.com/diegosouzapw/OmniRoute/tree/release/v3.8.51/docs/guides) (npm: see guide § Install) | Optional cloud-quota gateway on `127.0.0.1:20128` |
| FreeToken | [skill](skills/local-runtimes/references/freetoken.md) · [guide](guides/freetoken.md) | [FreeToken install.md](https://github.com/FlashML-org/FreeToken/blob/main/docs/install.md) | Optional local MoE / weights on `127.0.0.1:1919` |
| Colibri | [skill](skills/local-runtimes/references/colibri.md) · [guide](guides/colibri.md) | [Colibri README](https://github.com/JustVugg/colibri) | Optional frontier MoE on `127.0.0.1:8000` |
| Ollama | [skill](skills/local-runtimes/references/local-openai-compat.md) · [guide](guides/local-openai-compat.md) | [Ollama](https://ollama.com/) · [OpenAI compatibility](https://ollama.com/blog/openai-compatibility) | Optional local OpenAI-compat on `127.0.0.1:11434` |
| LM Studio | [skill](skills/local-runtimes/references/local-openai-compat.md) · [guide](guides/local-openai-compat.md) | [LM Studio OpenAI compat](https://lmstudio.ai/docs/developer/openai-compat) | Optional local OpenAI-compat on `127.0.0.1:1234` |
| llama.cpp | [skill](skills/local-runtimes/references/local-openai-compat.md) · [guide](guides/local-openai-compat.md) | [llama.cpp](https://github.com/ggml-org/llama.cpp) | Optional local OpenAI-compat on `127.0.0.1:8080` |
| OpenCode | [skill](skills/local-agency/SKILL.md) · [guide](guides/local-agency.md) | [OpenCode docs](https://opencode.ai/docs) | Optional local coding agency CLI; CE never installs it |
...
[OmniRoute skill](skills/local-runtimes/references/omniroute.md) provides an optional,
...
[FreeToken skill](skills/local-runtimes/references/freetoken.md) is an optional standalone local
...
### Optional local OpenAI-compat runtimes

[Local OpenAI-compat skill](skills/local-runtimes/references/local-openai-compat.md) covers Ollama
(`:11434`), LM Studio (`:1234`), and llama.cpp server (`:8080`) as standalone
peers (not OmniRoute/FreeToken plugins). Operator setup: follow vendor docs
linked in the third-party table and our
[local OpenAI-compat guide](guides/local-openai-compat.md). ChaosEngine never
installs or starts these servers. Missing them is normal.
...
| [`skills/omniroute/SKILL.md`](skills/local-runtimes/references/omniroute.md) | Optional fail-closed transport; CE does not install OmniRoute — see [Third-party companions](#third-party-companions-probe--use--do-not-install) |
| [`skills/freetoken/SKILL.md`](skills/local-runtimes/references/freetoken.md) | Optional FreeToken companion skill; not installed, not a workflow owner — see [Third-party companions](#third-party-companions-probe--use--do-not-install) |
| [`skills/local-openai-compat/SKILL.md`](skills/local-runtimes/references/local-openai-compat.md) | Optional Ollama/LM Studio/llama.cpp OpenAI-compat peers; not installed — see [Third-party companions](#third-party-companions-probe--use--do-not-install) |
| [`skills/local-agency/SKILL.md`](skills/local-agency/SKILL.md) | Optional OpenCode local-agency routing; not installed — see [Third-party companions](#third-party-companions-probe--use--do-not-install) |
...
| [`consumer_mode.py`](consumer_mode.py) | `--consumer` install: no tracked-file edits; overlay hidden via `.git/info/exclude` |
...
| Item | Purpose | Source of truth | Status | Platforms | Provisioner | Owner | Failure behavior |
| --- | --- | --- | --- | --- | --- | --- | --- |
| argparse | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/ce_brief.py, chaos-engine/deep_research.py, chaos-engine/dependencies.py, chaos-engine/draft_skill_pr.py, chaos-engine/harness_index.py, chaos-engine/heuristics.py, chaos-engine/hooks/receipt_shim.py, chaos-engine/hooks/reflection.py, chaos-engine/install.py, chaos-engine/learn_traces.py, chaos-engine/learning.py, chaos-engine/learning_session.py, chaos-engine/meta_optimize.py, chaos-engine/phase_ledger.py, chaos-engine/retrieve.py, chaos-engine/session_token_usage.py, chaos-engine/significance.py, chaos-engine/silent_verify.py, chaos-engine/skill_compress_audit.py, chaos-engine/skills/colibri/scripts/probe.py, chaos-engine/skills/freetoken/scripts/probe.py, chaos-engine/skills/local-agency/scripts/assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/design_turn_gate.py, chaos-engine/skills/local-agency/scripts/dispatch.py, chaos-engine/skills/local-agency/scripts/executor_brief.py, chaos-engine/skills/local-agency/scripts/require_rog_freetoken.py, chaos-engine/skills/local-agency/scripts/tip_preflight.py, chaos-engine/skills/local-coding-delegate/scripts/probe_hardware.py, chaos-engine/skills/local-openai-compat/scripts/probe.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/wake_pack.py, chaos-engine/worktree_overlay.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| ast | Portable runtime standard-library dependency. | chaos-engine/skills/local-agency/scripts/tip_preflight.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| base64 | Portable runtime standard-library dependency. | chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/skills/local-agency/scripts/require_rog_freetoken.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| collections | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/lifecycle.py, chaos-engine/learn_traces_mrv.py, chaos-engine/mcp_policy.py, chaos-engine/silent_verify.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| contextlib | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/dependencies.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/kernel.py, chaos-engine/hooks/lifecycle.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learning.py, chaos-engine/learning_session.py, chaos-engine/silent_verify.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| datetime | Portable runtime standard-library dependency. | chaos-engine/deep_research.py, chaos-engine/dependencies.py, chaos-engine/hooks/reflection.py, chaos-engine/hosts.py, chaos-engine/learn_traces.py, chaos-engine/learn_traces_mrv.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| fcntl | Portable runtime standard-library dependency. | chaos-engine/dependencies.py, chaos-engine/hooks/kernel.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learning.py, chaos-engine/stores.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| grp | Portable runtime standard-library dependency. | chaos-engine/skills/omniroute/scripts/runner.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| hashlib | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/dependencies.py, chaos-engine/heuristics.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/kernel.py, chaos-engine/hooks/reflection.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learning.py, chaos-engine/learning_session.py, chaos-engine/overlay_match.py, chaos-engine/significance.py, chaos-engine/skills/local-agency/scripts/tip_preflight.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| importlib | Portable runtime standard-library dependency. | chaos-engine/draft_skill_pr.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/lifecycle.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learn_traces.py, chaos-engine/learning.py, chaos-engine/learning_session.py, chaos-engine/meta_optimize.py, chaos-engine/official_self_heal.py, chaos-engine/overlay_match.py, chaos-engine/retrieve.py, chaos-engine/silent_verify.py, chaos-engine/skills/local-agency/scripts/dispatch.py, chaos-engine/skills/local-agency/scripts/require_rog_freetoken.py, chaos-engine/skills/local-agency/scripts/tests/test_assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/tip_preflight.py, chaos-engine/skills/local-coding-delegate/hardware_probe.py, chaos-engine/tool.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| inspect | Portable runtime standard-library dependency. | chaos-engine/install.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| io | Portable runtime standard-library dependency. | chaos-engine/hooks/lifecycle.py, chaos-engine/overlay_match.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| json | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/ce_brief.py, chaos-engine/deep_research.py, chaos-engine/dependencies.py, chaos-engine/draft_skill_pr.py, chaos-engine/grok_lean_config.py, chaos-engine/harness_index.py, chaos-engine/heuristics.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/kernel.py, chaos-engine/hooks/lifecycle.py, chaos-engine/hooks/receipt_shim.py, chaos-engine/hooks/reflection.py, chaos-engine/hooks/retrieve_justification.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learn_traces.py, chaos-engine/learn_traces_mrv.py, chaos-engine/learning.py, chaos-engine/learning_counters.py, chaos-engine/learning_session.py, chaos-engine/mcp_policy.py, chaos-engine/meta_optimize.py, chaos-engine/official_self_heal.py, chaos-engine/overlay_match.py, chaos-engine/phase_ledger.py, chaos-engine/retrieve.py, chaos-engine/session_token_usage.py, chaos-engine/significance.py, chaos-engine/skill_compress_audit.py, chaos-engine/skills/colibri/scripts/probe.py, chaos-engine/skills/freetoken/scripts/probe.py, chaos-engine/skills/local-agency/scripts/assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/design_turn_gate.py, chaos-engine/skills/local-agency/scripts/dispatch.py, chaos-engine/skills/local-agency/scripts/executor_brief.py, chaos-engine/skills/local-agency/scripts/require_rog_freetoken.py, chaos-engine/skills/local-agency/scripts/tests/test_assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/tip_preflight.py, chaos-engine/skills/local-coding-delegate/scripts/probe_hardware.py, chaos-engine/skills/local-openai-compat/scripts/probe.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py, chaos-engine/wake_pack.py, chaos-engine/worktree_overlay.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| msvcrt | Portable runtime standard-library dependency. | chaos-engine/dependencies.py, chaos-engine/hooks/kernel.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learning.py, chaos-engine/stores.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| os | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/consumer_mode.py, chaos-engine/dependencies.py, chaos-engine/draft_skill_pr.py, chaos-engine/grok_lean_config.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/kernel.py, chaos-engine/hooks/lifecycle.py, chaos-engine/hooks/receipt_shim.py, chaos-engine/hooks/reflection.py, chaos-engine/hooks/retrieve_justification.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learn_traces.py, chaos-engine/learning.py, chaos-engine/learning_session.py, chaos-engine/mcp_policy.py, chaos-engine/official_self_heal.py, chaos-engine/overlay_match.py, chaos-engine/retrieve.py, chaos-engine/significance.py, chaos-engine/skills/local-agency/scripts/assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/require_rog_freetoken.py, chaos-engine/skills/local-coding-delegate/scripts/probe_hardware.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py, chaos-engine/tool.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| pathlib | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/ce_brief.py, chaos-engine/consumer_mode.py, chaos-engine/deep_research.py, chaos-engine/dependencies.py, chaos-engine/draft_skill_pr.py, chaos-engine/grok_lean_config.py, chaos-engine/harness_index.py, chaos-engine/heuristics.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/kernel.py, chaos-engine/hooks/lifecycle.py, chaos-engine/hooks/receipt_shim.py, chaos-engine/hooks/reflection.py, chaos-engine/hooks/retrieve_justification.py, chaos-engine/hosts.py, chaos-engine/identity_md.py, chaos-engine/install.py, chaos-engine/learn_traces.py, chaos-engine/learn_traces_mrv.py, chaos-engine/learning.py, chaos-engine/learning_counters.py, chaos-engine/learning_session.py, chaos-engine/mcp_policy.py, chaos-engine/meta_optimize.py, chaos-engine/official_self_heal.py, chaos-engine/overlay_match.py, chaos-engine/phase_ledger.py, chaos-engine/retrieve.py, chaos-engine/session_token_usage.py, chaos-engine/significance.py, chaos-engine/silent_verify.py, chaos-engine/skill_compress_audit.py, chaos-engine/skills/local-agency/scripts/assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/design_turn_gate.py, chaos-engine/skills/local-agency/scripts/dispatch.py, chaos-engine/skills/local-agency/scripts/executor_brief.py, chaos-engine/skills/local-agency/scripts/require_rog_freetoken.py, chaos-engine/skills/local-agency/scripts/tests/test_assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/tip_preflight.py, chaos-engine/skills/local-coding-delegate/hardware_probe.py, chaos-engine/skills/local-coding-delegate/scripts/probe_hardware.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py, chaos-engine/tool.py, chaos-engine/wake_pack.py, chaos-engine/worktree_overlay.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| platform | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/dependencies.py, chaos-engine/hosts.py, chaos-engine/skills/local-coding-delegate/scripts/probe_hardware.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| pwd | Portable runtime standard-library dependency. | chaos-engine/skills/omniroute/scripts/runner.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| re | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/dependencies.py, chaos-engine/grok_lean_config.py, chaos-engine/heuristics.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/kernel.py, chaos-engine/hooks/reflection.py, chaos-engine/hooks/retrieve_justification.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learn_traces.py, chaos-engine/learn_traces_mrv.py, chaos-engine/learning.py, chaos-engine/mcp_policy.py, chaos-engine/overlay_match.py, chaos-engine/phase_ledger.py, chaos-engine/retrieve.py, chaos-engine/session_token_usage.py, chaos-engine/significance.py, chaos-engine/skill_compress_audit.py, chaos-engine/skills/local-agency/scripts/design_turn_gate.py, chaos-engine/skills/local-agency/scripts/executor_brief.py, chaos-engine/skills/local-agency/scripts/tip_preflight.py, chaos-engine/skills/omniroute/scripts/runner.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| runpy | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/dependencies.py, chaos-engine/hooks/guard.py, chaos-engine/install.py, chaos-engine/tool.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| secrets | Portable runtime standard-library dependency. | chaos-engine/dependencies.py, chaos-engine/hooks/reflection.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/overlay_match.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| shlex | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/retrieve_justification.py, chaos-engine/skills/omniroute/scripts/runner.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| shutil | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/dependencies.py, chaos-engine/draft_skill_pr.py, chaos-engine/grok_lean_config.py, chaos-engine/hooks/guard.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/official_self_heal.py, chaos-engine/skills/colibri/scripts/probe.py, chaos-engine/skills/freetoken/scripts/probe.py, chaos-engine/skills/local-agency/scripts/dispatch.py, chaos-engine/skills/local-agency/scripts/tip_preflight.py, chaos-engine/skills/local-openai-compat/scripts/probe.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py, chaos-engine/tool.py, chaos-engine/worktree_overlay.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| socket | Portable runtime standard-library dependency. | chaos-engine/skills/local-agency/scripts/assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/require_rog_freetoken.py, chaos-engine/skills/local-agency/scripts/tests/test_assert_parent_rog_shell.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| sqlite3 | Portable runtime standard-library dependency. | chaos-engine/dependencies.py, chaos-engine/hosts.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| subprocess | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/consumer_mode.py, chaos-engine/dependencies.py, chaos-engine/draft_skill_pr.py, chaos-engine/grok_lean_config.py, chaos-engine/hooks/guard.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learning.py, chaos-engine/mcp_policy.py, chaos-engine/overlay_match.py, chaos-engine/retrieve.py, chaos-engine/silent_verify.py, chaos-engine/skills/local-agency/scripts/tests/test_assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/tip_preflight.py, chaos-engine/skills/local-coding-delegate/scripts/probe_hardware.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py, chaos-engine/tool.py, chaos-engine/worktree_overlay.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| sys | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/ce_brief.py, chaos-engine/deep_research.py, chaos-engine/dependencies.py, chaos-engine/draft_skill_pr.py, chaos-engine/harness_index.py, chaos-engine/hooks/guard.py, chaos-engine/hooks/lifecycle.py, chaos-engine/hooks/receipt_shim.py, chaos-engine/hosts.py, chaos-engine/install.py, chaos-engine/learn_traces.py, chaos-engine/learning.py, chaos-engine/learning_session.py, chaos-engine/overlay_match.py, chaos-engine/retrieve.py, chaos-engine/session_token_usage.py, chaos-engine/silent_verify.py, chaos-engine/skills/colibri/scripts/probe.py, chaos-engine/skills/freetoken/scripts/probe.py, chaos-engine/skills/local-agency/scripts/assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/dispatch.py, chaos-engine/skills/local-agency/scripts/executor_brief.py, chaos-engine/skills/local-agency/scripts/require_rog_freetoken.py, chaos-engine/skills/local-agency/scripts/tests/test_assert_parent_rog_shell.py, chaos-engine/skills/local-agency/scripts/tip_preflight.py, chaos-engine/skills/local-coding-delegate/scripts/probe_hardware.py, chaos-engine/skills/local-openai-compat/scripts/probe.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py, chaos-engine/tool.py, chaos-engine/worktree_overlay.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| tarfile | Portable runtime standard-library dependency. | chaos-engine/dependencies.py, chaos-engine/overlay_match.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| tempfile | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/hooks/reflection.py, chaos-engine/install.py, chaos-engine/learning.py, chaos-engine/overlay_match.py, chaos-engine/skills/local-agency/scripts/dispatch.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| threading | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/hooks/kernel.py, chaos-engine/hosts.py, chaos-engine/learning.py, chaos-engine/skills/omniroute/scripts/runner.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| time | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/dependencies.py, chaos-engine/draft_skill_pr.py, chaos-engine/heuristics.py, chaos-engine/hooks/kernel.py, chaos-engine/hooks/receipt_shim.py, chaos-engine/install.py, chaos-engine/learning.py, chaos-engine/learning_counters.py, chaos-engine/meta_optimize.py, chaos-engine/phase_ledger.py, chaos-engine/significance.py, chaos-engine/skills/omniroute/scripts/runner.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| tomllib | Portable runtime standard-library dependency. | chaos-engine/overlay_match.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| types | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/hooks/kernel.py, chaos-engine/install.py, chaos-engine/skills/local-agency/scripts/dispatch.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| typing | Portable runtime standard-library dependency. | chaos-engine/draft_skill_pr.py, chaos-engine/heuristics.py, chaos-engine/hooks/kernel.py, chaos-engine/learning_counters.py, chaos-engine/meta_optimize.py, chaos-engine/official_self_heal.py, chaos-engine/phase_ledger.py, chaos-engine/retrieve.py, chaos-engine/significance.py, chaos-engine/silent_verify.py, chaos-engine/skill_compress_audit.py, chaos-engine/skills/omniroute/scripts/proof.py, chaos-engine/skills/omniroute/scripts/runner.py, chaos-engine/stores.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
| urllib | Portable runtime standard-library dependency. | chaos-engine/bootstrap.py, chaos-engine/dependencies.py, chaos-engine/hosts.py, chaos-engine/learning.py, chaos-engine/skills/colibri/scripts/probe.py, chaos-engine/skills/freetoken/scripts/probe.py, chaos-engine/skills/local-agency/scripts/dispatch.py, chaos-engine/skills/local-openai-compat/scripts/probe.py, chaos-engine/skills/omniroute/scripts/runner.py | required | Windows, Linux, macOS | resolved latest stable Python | Python runtime | affected command fails closed |
...
| colibri | >- | chaos-engine/skills/colibri/SKILL.md | optional routed | all hosts | core or pinned vendor installer | skill package | required skill blocks routing; optional skill reports capability gap |
...
| local-agency | >- | chaos-engine/skills/local-agency/SKILL.md | optional routed | all hosts | core or pinned vendor installer | skill package | required skill blocks routing; optional skill reports capability gap |
...
| local-openai-compat | >- | chaos-engine/skills/local-openai-compat/SKILL.md | optional routed | all hosts | core or pinned vendor installer | skill package | required skill blocks routing; optional skill reports capability gap |
| local-runtimes | >- | chaos-engine/skills/local-runtimes/SKILL.md | optional routed | all hosts | core or pinned vendor installer | skill package | required skill blocks routing; optional skill reports capability gap |
...
flowchart LR
    ...
    CE --> LocalAgency[local-agency optional]
    CE --> FreeToken[freetoken optional]
    CE --> LocalOpenAI[local-openai-compat optional]
