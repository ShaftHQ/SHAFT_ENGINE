...
[Local OpenAI-compat skill](skills/local-openai-compat/SKILL.md) covers Ollama
...
| [`skills/local-openai-compat/SKILL.md`](skills/local-openai-compat/SKILL.md) | Optional Ollama/LM Studio/llama.cpp OpenAI-compat peers; not installed — see [Third-party companions](#third-party-companions-probe--use--do-not-install) |
