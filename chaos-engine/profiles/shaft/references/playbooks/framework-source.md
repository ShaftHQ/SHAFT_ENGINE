...
- **Overload `@param` arity (before push):** when adding or splitting overloads,
  ...
  (#5748). Run
  `scripts/ci/check_javadoc_param_arity.py` (repo-only)
...
- Route release metadata work through
  [the release guard](release-dependency-guard.md).
