...
[FreeToken](freetoken.md): probe and dispatch against an already-running
...
Probe helper:
[`chaos-engine/skills/local-openai-compat/scripts/probe.py`](../../local-openai-compat/scripts/probe.py).
...
- FreeToken peer: [freetoken skill](freetoken.md)
- Local OpenCode agency: [local-agency](../../local-agency/SKILL.md)
- OmniRoute peer (cloud-quota, not a dependency): [omniroute skill](omniroute.md)
