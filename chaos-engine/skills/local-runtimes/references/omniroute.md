<!-- Folded from skills/omniroute/SKILL.md (#6200). -->
# OmniRoute
...
[references/docs-study-notes.md](../../omniroute/references/docs-study-notes.md). Living
lessons: [references/living-lessons.md](../../omniroute/references/living-lessons.md).
...
rules and CLI: [references/proof-of-dispatch.md](../../omniroute/references/proof-of-dispatch.md).
...
Anti-patterns: static model allowlists as primary selector; `candidates` then native host while READY; `claude`+Kimi/Qwen without discovery aliases; broad `pkill -f` on launcher argv (see [process lifecycle](../../omniroute/references/process-lifecycle.md)).
...
blocker unless [proof-of-dispatch](../../omniroute/references/proof-of-dispatch.md) is met.
...
[living-lessons](../../omniroute/references/living-lessons.md)).
...
Runner commands, state, and receipts: [runner](../../omniroute/references/runner.md).

## Delegate continuity

Opt-in bounded continuity (capability floor, alternates, `_supervise`) lives in
[references/delegate-continuity.md](../../omniroute/references/delegate-continuity.md). Omit
