<!-- Folded from skills/colibri/SKILL.md (#6200). -->
# Colibri
...
Probe helper: [`chaos-engine/skills/colibri/scripts/probe.py`](../../colibri/scripts/probe.py).
...
- FreeToken peer: [freetoken skill](freetoken.md) · guide (repo-only `chaos-engine/guides/freetoken.md`)
- Local agency: [local-agency](../../local-agency/SKILL.md)
- Local OpenAI-compat peers: [local-openai-compat](local-openai-compat.md)
