...
- **💻 CLI Module**: Local and remote command execution (including JSch SSH with `TerminalActions` and reusable `RemoteSshClient` via `SHAFT.CLI.remoteSsh`), plus file system operations
