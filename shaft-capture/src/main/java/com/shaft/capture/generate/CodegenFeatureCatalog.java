...
public final class CodegenFeatureCatalog {
    private static final List<Feature> FEATURES = List.of(
            ...
            feature("Recording UI", "Record at cursor", "Record at cursor",
                    "AGENT_MAPPED", "MCP returns duplicate-aware method/code blocks for insertion at an agent-selected location."),
            ...
            feature("Agent", "Context-aware insertion into Page Objects", "MCP code blocks",
                    "SUPPORTED", "MCP returns full-class, method, recommended target/anchor, and agent integration blocks; record-at-target snippets reuse existing locator fields and skip duplicate action lines."),
