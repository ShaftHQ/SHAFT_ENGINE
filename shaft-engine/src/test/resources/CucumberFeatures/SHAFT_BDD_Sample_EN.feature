...
#    Then I Assert that the element found by "xpath": "(//img[contains(@src,'shaft.svg')])[1]", strictly matches with the expected reference image using AI (Applitools Eyes)
#    Then I Assert that the element found by "xpath": "(//img[contains(@src,'shaft.svg')])[1]", does not strictly match with the expected reference image using AI (Applitools Eyes)
#    Then I Assert that the element found by "xpath": "(//img[contains(@src,'shaft.svg')])[1]", matches the content of the expected reference image using AI (Applitools Eyes)
#    Then I Assert that the element found by "xpath": "(//img[contains(@src,'shaft.svg')])[1]", does not match the content of the expected reference image using AI (Applitools Eyes)
#    Then I Assert that the element found by "xpath": "(//img[contains(@src,'shaft.svg')])[1]", matches the layout of the expected reference image using AI (Applitools Eyes)
#    Then I Assert that the element found by "xpath": "(//img[contains(@src,'shaft.svg')])[1]", does not match the layout of the expected reference image using AI (Applitools Eyes)
    And I Close the current window
