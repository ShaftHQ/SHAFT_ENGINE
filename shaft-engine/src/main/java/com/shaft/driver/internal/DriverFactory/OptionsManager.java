...
//            appiumCapabilities.setCapability("appium:otherApps", ",,,");
    ...
    private ChromiumOptions<?> setupChromiumOptions(ChromiumOptions<?> options, MutableCapabilities customDriverOptions) {
        ...
        // Chromium prefs are typed: a string "false" is ignored and the OS save dialog returns.
        Map<String, Object> chromePreferences = new HashMap<>();
        chromePreferences.put("download.prompt_for_download", false);
        chromePreferences.put("download.directory_upgrade", true);
        chromePreferences.put("profile.default_content_setting_values.automatic_downloads", 1);
        chromePreferences.put("download.default_directory", resolvedDownloadsDirectory());
    ...
    private static String resolvedDownloadsDirectory() {
