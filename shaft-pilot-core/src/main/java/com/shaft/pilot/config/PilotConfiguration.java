...
public record PilotConfiguration(
    ...
    public static PilotConfiguration current() {
        ...
        Map<String, ProviderConfiguration> providers = Map.of(
                ...
                "github", provider("github", properties.githubEndpoint(), properties.githubModel(),
                        properties.githubApiKeyEnvironmentVariable(),
                        parseLocation(properties.githubProcessingLocation(), ProcessingLocation.REMOTE)),
