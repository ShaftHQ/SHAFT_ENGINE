 ...
 * {@code Properties.paths.performanceReportPath()}.
 *
 * <p>Report generation is guarded by the {@code Properties.performance.isEnablePerformanceReport()}
...
public class ApiPerformanceExecutionReport {
     ...
     * {@code Properties.performance.isEnablePerformanceReport()} returns {@code false}.
     *
     * <p>Example:
     * <pre>{@code
    ...
    public static void generatePerformanceReport(Map<String, List<Double>> performanceData, long startTime, long endTime) {
        ...
        if (!Properties.performance.isEnablePerformanceReport()) {
        ...
        fileActionsSession.createFolder(Properties.paths.performanceReportPath());
        // Get the custom report path
        //String reportPath = Properties.paths.performanceReport();
        ...
        //String reportPath = Properties.paths.performanceReport() + "/PerformanceReport_" + getTimestamp() + ".html";
        //saveHtmlToFile(reportPath, htmlReport);
        fileActionsSession.writeToFile(Properties.paths.performanceReportPath(), "PerformanceReport_" + getTimestamp() + ".html", htmlReport);
