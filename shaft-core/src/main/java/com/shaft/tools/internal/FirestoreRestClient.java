...
public class FirestoreRestClient {
    ...
    // See: Properties.internal.ga4MeasurementId() / ga4ApiSecret()
    ...
    public static void sendTelemetry(long executionStartTime, long executionEndTime,
        ...
        if (!Properties.flags.telemetryEnabled()) {
    ...
    public static void logEventToAnalytics(String eventName, long executionStartTime,
        ...
        String measurementId = Properties.internal.ga4MeasurementId();
        String apiSecret = Properties.internal.ga4ApiSecret();
        ...
        eventParams.put("engine_version", Properties.internal.shaftEngineVersion());
        eventParams.put("target_os", Properties.platform.targetPlatform());
        eventParams.put("target_browser", Properties.web.targetBrowserName());
