...
public class GoogleTink {
    ...
    public static void initialize() {
        keysetFilename = Properties.tinkey.keysetFilename();
        masterKeyUri = Properties.tinkey.kmsMasterKeyUri();
        kms = Properties.tinkey.kmsServerType();
        credentialPath = Properties.tinkey.kmsCredentialPath();
    ...
    public static void encrypt() {
        if (!"".equals(keysetFilename)) {
            String relativeFolderPath = Properties.paths.testData();
