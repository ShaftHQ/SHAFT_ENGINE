...
public class XrayIntegrationHelper {
    ...
    private static final String authType = Properties.jira.authType() + " ";
    private static final String _ProjectKey = Properties.jira.projectKey();
    private static String _JiraAuthorization = Properties.jira.authorization();
    private static String _TestExecutionID = null;

    private static void setup() {
        baseURI = Properties.jira.url();
        ...
        try {
            ...
            Response response = given()
                    ...
                    .body(issueRequestBody
                            ...
                            .replace("${ASSIGNEE_NAME}", Properties.jira.assignee())
                    )
