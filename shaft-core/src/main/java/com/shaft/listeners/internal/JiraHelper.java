...
public class JiraHelper {
    public static void reportExecutionStatusToJira() {
        if (Properties.jira.isEnabled() && Properties.jira.reportTestCasesExecution()) {
            try {
                var reportPath = Properties.jira.reportPath();
                ...
                XrayIntegrationHelper.renameTestExecutionSuit(Properties.jira.executionName(),
                        Properties.jira.executionDescription());
    ...
    public static void reportBugsToJIRA(List<String> attachments, String logText, ITestResult iTestResult, ITestNGMethod iTestNGMethod) {
        if (!iTestResult.isSuccess()
                && Properties.jira.isEnabled()
                && Properties.jira.reportBugs()) {
