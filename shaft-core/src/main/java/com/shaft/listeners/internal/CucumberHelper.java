...
public class CucumberHelper {
    ...
    public static void configureCucumberProperties(List<XmlSuite> suites) {
        suites.forEach(suite -> {
            ...
            params.put("cucumber.ansi-colors.disabled", String.valueOf(Properties.cucumber.cucumberAnsiColorsDisabled()));
            params.put("cucumber.execution.dry-run", String.valueOf(Properties.cucumber.cucumberExecutionDryRun()));
            params.put("cucumber.execution.limit", Properties.cucumber.cucumberExecutionLimit());
            params.put("cucumber.execution.order", Properties.cucumber.cucumberExecutionOrder());
            params.put("cucumber.execution.wip", String.valueOf(Properties.cucumber.cucumberExecutionWip()));
            params.put("cucumber.features", Properties.cucumber.cucumberFeatures());
            params.put("cucumber.filter.name", Properties.cucumber.cucumberFilterName());
            params.put("cucumber.filter.tags", Properties.cucumber.cucumberFilterTags());
            params.put("cucumber.glue", Properties.cucumber.cucumberGlue());
            params.put("cucumber.plugin", Properties.cucumber.cucumberPlugin());
            params.put("cucumber.object-factory", Properties.cucumber.cucumberObjectFactory());
            params.put("cucumber.snippet-type", Properties.cucumber.cucumberSnippetType());
    ...
    public static void engineSetup() {
        ...
        ThreadLocalPropertiesManager.setGlobalProperty("cucumber.options",
                " --dry-run " + Properties.cucumber.cucumberExecutionDryRun() +
                        " --features " + Properties.cucumber.cucumberFeatures() +
                        " --name " + Properties.cucumber.cucumberFilterName() +
                        " --tags " + Properties.cucumber.cucumberFilterTags() +
                        " --glue " + Properties.cucumber.cucumberGlue() +
                        " --plugin " + Properties.cucumber.cucumberPlugin() +
                        " --quiet " + Properties.cucumber.cucumberPublishQuiet() +
                        " --publish " + !Properties.cucumber.cucumberPublishQuiet()
        );
    }
