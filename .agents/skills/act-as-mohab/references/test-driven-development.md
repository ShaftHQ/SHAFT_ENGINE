...
Feeling the pull to write code first, or to accept tests written after the
fact? Read [resisting rationalization](tdd/resisting-rationalization.md)
before you act on it — it walks through why each common excuse ("I'll test
after", "already manually tested", "deleting X hours is wasteful") is wrong,
and the exact red flags that mean: delete the code, start over with TDD.
...
When adding mocks or test utilities, read [testing anti-patterns](tdd/testing-anti-patterns.md) to avoid common pitfalls:
