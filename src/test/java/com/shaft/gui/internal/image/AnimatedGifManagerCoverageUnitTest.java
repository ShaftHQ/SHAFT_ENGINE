...
public class AnimatedGifManagerCoverageUnitTest {
    ...
    private static String getGifRelativePath() {
        try {
            Field field = AnimatedGifManager.class.getDeclaredField("gifRelativePathWithFileName");
    ...
    private static void clearAnimatedGifState() {
        try {
            clearThreadLocal("gifWriter");
            clearThreadLocal("imageWriteParam");
            clearThreadLocal("imageMetaData");
            clearThreadLocal("gifManager");
            clearThreadLocal("gifRelativePathWithFileName");

            Field outputStreamField = AnimatedGifManager.class.getDeclaredField("gifOutputStream");
