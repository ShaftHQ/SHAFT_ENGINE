...
public class GoogleSearchSteps {
	...
	public void i_validate_that_page_title_is_equal_to_expected_title_from_test_data() throws Throwable {
		searchObject.verifyPageTitle(testDataReader.getCellData("Expected Page Title")); // Check that page title is equal to expected title from test data
	}
	...
	public void i_perform_search_for_the_query_that_is_retrieved_from_test_data() throws Throwable {
		searchObject.searchForQuery(testDataReader.getCellData("Search Query")); // Perform search for the query that is retrieved from test data
	}
	...
	public void i_validate_that_search_results_counter_holds_a_value_expected_to_pass() throws Throwable {
		...
		resultsObject.assertResultsStatsExistsAndIsNotEmpty(); // Check that search results counter holds a value (expected to pass)
	}
	...
	public void i_click_the_next_button_to_make_sure_that_the_framework_can_scroll_element_into_view_before_clicking_it()
			throws Throwable {
		resultsObject.clickNext(); // Clicks the next button to make sure that the framework can scroll element into view before clicking it
	}
