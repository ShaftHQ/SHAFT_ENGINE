...
public class Test_LTMobIPAAppURL {
    ...
    @Test
    public void test() {
        ElementActions.getInstance(driver.getDriver()).performTouchAction().tap(AppiumBy.accessibilityId("Text Button"));
        ElementActions.getInstance(driver.getDriver()).type(AppiumBy.accessibilityId("Text Input"), "hello@browserstack.com" + "\n");
