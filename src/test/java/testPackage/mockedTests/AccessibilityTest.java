...
public class AccessibilityTest {
    ...
    public void testAnalyzeAndReturnDefault() {
        try {
            var result = driver.get().browser().accessibility().analyzeAndReturn("ReturnedResultPage",false);
    ...
    public void testBackToBrowser() {
        var browserActions = driver.get().browser()
                .accessibility()
                .backToBrowser();
