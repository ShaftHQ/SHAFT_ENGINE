...
public class BuildAndRelease {
	...
	public void installToLocalRepository() {
		...
		DriverFactory.getTerminalDriver().performTerminalCommand("mvn clean install -DskipTests");
	...
	public void publishJavaDocs() {
		...
		DriverFactory.getTerminalDriver().performTerminalCommand("mvn resources:resources javadoc:javadoc scm-publish:publish-scm");
	...
	private void deployFileToJfrog(String filePostfix) {
		...
		DriverFactory.getAPIDriver(baseUri)
