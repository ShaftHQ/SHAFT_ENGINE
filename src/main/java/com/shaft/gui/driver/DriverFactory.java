...
public class DriverFactory {
        ...
        switch (operatingSystem) {
            case WINDOWS:
                if (driverType.equals(DriverType.DESKTOP_FIREFOX) || driverType.equals(DriverType.DESKTOP_CHROME)
                        || driverType.equals(DriverType.DESKTOP_IE) || driverType.equals(DriverType.DESKTOP_EDGE)) {
            ...
            case MACOS:
                ...
                break;
            case ANDROID:
                if (driverType.equals(DriverType.MOBILE_CHROME) || driverType.equals(DriverType.MOBILE_CHROMIUM)
                        || driverType.equals(DriverType.MOBILE_BROWSER)) {
                    isCompatibleDriver = true;
                }
                break;
            case IOS:
    ...
    private static void setDriverOptions(String driverName, MutableCapabilities customDriverOptions) {
        ...
        switch (driverType) {
            ...
            case MOBILE_CHROME, DESKTOP_CHROME -> {
    ...
    private static void createNewLocalDriverInstanceForInternetExplorer() {
        ...
        storeDriverInstance(DriverType.DESKTOP_IE.getValue());
    ...
    private static WebDriver createNewLocalDriverInstance(String driverName) {
        ...
        switch (driverType) {
            ...
            case DESKTOP_IE -> createNewLocalDriverInstanceForInternetExplorer();
    ...
    private static WebDriver createNewRemoteDriverInstance(String driverName) {
        ...
        if (isMobileNativeExecution()) {
            driverType = DriverType.MOBILE_NATIVE;
        } else {
...
//            ReportManager.log(e);
    ...
    public enum DriverType {
        DESKTOP_FIREFOX("MozillaFirefox"), DESKTOP_CHROME("GoogleChrome"), DESKTOP_SAFARI("Safari"),
        DESKTOP_IE("MicrosoftInternetExplorer"), DESKTOP_EDGE("MicrosoftEdge"), MOBILE_CHROME("Chrome"),
