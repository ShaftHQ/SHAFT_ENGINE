...
public class BrowserFactory {
    ...
    public static WebDriver getBrowser() {
        return getBrowser(TARGET_BROWSER_NAME, null, true);
    }
    ...
    public static WebDriver getBrowser(BrowserType browserType) {
        return getBrowser(browserType.getValue(), null, true);
    }

    public static WebDriver getBrowser(BrowserType browserType, MutableCapabilities customBrowserOptions) {
        return getBrowser(browserType.getValue(), customBrowserOptions, true);
    }

    public static WebDriver getBrowser(BrowserType browserType, MutableCapabilities customBrowserOptions, boolean appendToDefaultOptions) {
        return getBrowser(browserType.getValue(), customBrowserOptions, appendToDefaultOptions);
    }
    ...
    private static void setDriverOptions(String browserName, MutableCapabilities customBrowserOptions, Boolean appendToDefault) {
        ...
        switch (browserType) {
            case MOZILLA_FIREFOX:
                ...
                if (customBrowserOptions != null && !appendToDefault) {
...
//            ReportManager.log(e);
     ...
     */
    private static synchronized WebDriver getBrowser(String browserName, MutableCapabilities customBrowserOptions, boolean appendToDefaultOptions) {
        initializeSystemProperties(System.getProperty("targetBrowserName") == null);
        ...
        try {
            ...
            if (!isMobileExecution()) {
                setDriverOptions(internalBrowserName, customBrowserOptions, appendToDefaultOptions);
