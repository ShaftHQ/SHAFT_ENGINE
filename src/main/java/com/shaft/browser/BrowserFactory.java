...
public class BrowserFactory {
    ...
    private static final String BROWSER_FIREFOX = "MozillaFirefox";
    private static final String BROWSER_CHROME = "GoogleChrome";
    private static final String BROWSER_SAFARI = "Safari";
    private static final String BROWSER_IE = "MicrosoftInternetExplorer";
    private static final String BROWSER_EDGE = "MicrosoftEdge";
	...
	case OS_WINDOWS:
	    if (browserName.equals(BROWSER_FIREFOX) || browserName.equals(BROWSER_CHROME)
		    || browserName.equals(BROWSER_IE) || browserName.equals(BROWSER_EDGE)) {
	...
	case OS_MAC:
	    if (browserName.equals(BROWSER_FIREFOX) || browserName.equals(BROWSER_CHROME)
		    || browserName.equals(BROWSER_SAFARI)) {
		isCompatibleBrowser = true;
	    }
	    break;
	default:
