...
public class ElementSteps {
    ...
    protected static By getLocatorFromTypeAndValue(LocatorType type, String locatorValue) {
        switch (type) {
            case ID -> {
...
//    @عندما("اقوم بكتابة {string} بداخل مربع الكتابة المحدد بإستخدام {locatorType} بقيمة {string}")
    public void type(String text, LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue the value/expression of the desired element locator
     */
    @When("I Type {string} securely into the element found by {locatorType}: {string}")
    public void typeSecure(String text, LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue the value/expression of the desired element locator
     */
    @When("I Append the text {string} to the element found by {locatorType}: {string}")
    public void typeAppend(String text, LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue     the value/expression of the desired element locator
     */
    @When("I Upload the file {string} to the element found by {locatorType}: {string}")
    public void typeFileLocationForUpload(String absoluteFilePath, LocatorType locatorType, String locatorValue) {
...
//    @عندما("اقوم بالضغط على زر {word} بداخل عنصر الويب المحدد بإستخدام {locatorType} بقيمة {string}")
    public void keyPress(String key, LocatorType locatorType, String locatorValue) {
    ...
    public void click(LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue the value/expression of the desired element locator
     */
    @When("I Click and hold the element found by {locatorType}: {string}")
    public void clickAndHold(LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue the value/expression of the desired element locator
     */
    @When("I use the clipboard to perform {word} on the element found by {locatorType}: {string}")
    public void clipboardActions(String action, LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue the value/expression of the desired element locator
     */
    @When("I Double-click the element found by {locatorType}: {string}")
    public void doubleClick(LocatorType locatorType, String locatorValue) {
     ...
     */
    @When("I Drag the element found by {locatorType}: {string} and drop it on the element found by {locatorType}: {string}")
    public void dragAndDrop(LocatorType sourceLocatorType, String sourceLocatorValue, LocatorType destinationLocatorType, String destinationLocatorValue) {
     ...
     *                     be moved
     */
    @When("I Drag the element found by {locatorType}: {string} and drop it by offset x={int} and y={int}")
    public void dragAndDropByOffset(LocatorType locatorType, String locatorValue, int xOffset, int yOffset) {
     ...
     * @param locatorValue the value/expression of the desired element locator
     */
    @When("I Hover over the element found by {locatorType}: {string}")
    public void hover(LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue the value/expression of the desired element locator
     */
    @When("I Select {string} from the drop-down list element found by {locatorType}: {string}")
    public void select(String text, LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue the value/expression of the desired element locator
     */
    @When("I Set the value {string} into the element found by {locatorType}: {string}")
    public void setValueUsingJavaScript(String value, LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue the value/expression of the desired element locator
     */
    @When("I Submit the form found by {locatorType}: {string}")
    public void submitFormUsingJavaScript(LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue  the value/expression of the desired element locator
     */
    @When("I Wait for {int} attempt(s) for the element found by {locatorType}: {string} to be present")
    public void waitForElementToBePresent(int numberOfTries, LocatorType locatorType, String locatorValue) {
     ...
     * @param locatorValue  the value/expression of the desired element locator
     */
    @When("I Wait for {int} attempt(s) for the element found by {locatorType}: {string} to be not present")
    public void waitForElementToBeNotPresent(int numberOfTries, LocatorType locatorType, String locatorValue) {
     ...
     */
    @When("I Wait for {int} attempt(s) for the text inside the element found by {locatorType}: {string} to change from the initial value {string}")
    public void waitForTextToChange(int numberOfTries, LocatorType locatorType, String locatorValue, String initialValue) {
