...
public class DriverFactoryHelper {
    ...
    private static DriverType getDriverTypeFromName(String driverName) {
        ...
        return DriverType.SELENIUM_CHROME;
    }
    ...
    private static void checkDriverOSCrossCompatibility(String driverName) {
        ...
        switch (operatingSystem) {
            case WINDOWS:
                if (driverType.equals(DriverType.SELENIUM_FIREFOX) || driverType.equals(DriverType.SELENIUM_CHROME)
                        || driverType.equals(DriverType.SELENIUM_INTERNET_EXPLORER) || driverType.equals(DriverType.SELENIUM_EDGE)) {
            ...
            case MACOS:
                if (driverType.equals(DriverType.SELENIUM_FIREFOX) || driverType.equals(DriverType.SELENIUM_CHROME)
                        || driverType.equals(DriverType.SELENIUM_SAFARI)) {
                    isCompatibleDriver = true;
                }
                break;
            case ANDROID:
                ...
                break;
            case IOS:
                if (driverType.equals(DriverType.SELENIUM_SAFARI)) {
                    isCompatibleDriver = true;
                }
                break;
    ...
    private static void setDriverOptions(String driverName, MutableCapabilities customDriverOptions) {
        ...
        switch (driverType) {
            ...
            case APPIUM_CHROME, SELENIUM_CHROME -> {
    ...
    private static void createNewLocalDriverInstanceForFirefox() {
        ...
        storeDriverInstance(DriverType.SELENIUM_FIREFOX.getValue());
    ...
    private static void createNewLocalDriverInstanceForInternetExplorer() {
        ...
        storeDriverInstance(DriverType.SELENIUM_INTERNET_EXPLORER.getValue());
    ...
    private static void createNewLocalDriverInstanceForChrome() {
        ...
        storeDriverInstance(DriverType.SELENIUM_CHROME.getValue());
    ...
    private static void createNewLocalDriverInstanceForEdge() {
        ...
        storeDriverInstance(DriverType.SELENIUM_EDGE.getValue());
    ...
    private static void createNewLocalDriverInstanceForSafari() {
        try {
            ...
            failAction("Failed to create a session on" + DriverType.SELENIUM_SAFARI);
        }
        storeDriverInstance(DriverType.SELENIUM_SAFARI.getValue());
    ...
    private static WebDriver createNewLocalDriverInstance(String driverName) {
        ...
        switch (driverType) {
            case SELENIUM_FIREFOX -> createNewLocalDriverInstanceForFirefox();
            case SELENIUM_INTERNET_EXPLORER -> createNewLocalDriverInstanceForInternetExplorer();
            case SELENIUM_CHROME -> createNewLocalDriverInstanceForChrome();
            case SELENIUM_EDGE -> createNewLocalDriverInstanceForEdge();
            case SELENIUM_SAFARI -> createNewLocalDriverInstanceForSafari();
            default -> failAction("Unsupported Driver Type [" + driverName + "].");
        }
        return driver.get();
    }
        ...
        try {
            ...
            if (!isMobileNativeExecution()) {
                ...
                if (Boolean.TRUE.equals(AUTO_MAXIMIZE) && !isMobileWebExecution()
                        && (!DriverType.SELENIUM_CHROME.equals(getDriverTypeFromName(internalDriverName)) || OperatingSystemType.MACOS.equals(getOperatingSystemFromName(targetOperatingSystem)))) {
