...
//                ffOptions.setCapability(CapabilityType.BROWSER_NAME, driverType.getValue());
                ...
                if (Boolean.TRUE.equals(Boolean.valueOf(System.getProperty("captureWebDriverLogs").trim()))) {
                    ffOptions.setCapability(CapabilityType.LOGGING_PREFS, logPrefs); // BREAKS HEADLESS EXECUTION?!
                }
...
//                options.setCapability(CapabilityType.BROWSER_NAME, driverType.getValue());
