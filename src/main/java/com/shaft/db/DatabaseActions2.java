...
public class DatabaseActions2 {
     ...
     */
    public DatabaseActions2(String dbType, String dbServerIP, String dbPort, String dbName, String username,
	    String password) {
	this.dbType = dbType;
     ...
     */
    public static String getStringValue(ResultSet resultSet) {
    ...
    /**
     * Returns the number of rows returned inside the provided resultSet
     * 
     * @param resultSet the object returned as a result of performing a certain
     *                  database query
     * @return an integer value which represents the number of rows returned inside
	...
	try {
	    ...
	    ReportManager.log(e);
	    failAction("getResultSetRowCount");
	}
	return rowCount;
    }
