...
public class Assertions {
	...
	public static void assertNull(Object object, String... customLogMessage) {
		ValidationHelper.validateNull(ValidationHelper.ValidationCategory.HARD_ASSERT, object, ValidationType.POSITIVE,
				customLogMessage);
	}
	...
	public static void assertNull(Object object, AssertionType assertionType, String... customLogMessage) {
		ValidationHelper.validateNull(ValidationHelper.ValidationCategory.HARD_ASSERT, object,
				ValidationType.valueOf(assertionType.toString()), customLogMessage);
	}
	...
	public static void assertElementExists(WebDriver driver, By elementLocator, String... customLogMessage) {
		ValidationHelper.validateElementExists(ValidationHelper.ValidationCategory.HARD_ASSERT, driver, elementLocator,
	 ...
	 */
	public static void assertElementAttribute(WebDriver driver, By elementLocator,
			ElementAttributeType elementAttributeType, String expectedValue, String... customLogMessage) {
		ValidationHelper.validateElementAttribute(ValidationHelper.ValidationCategory.HARD_ASSERT, driver,
				elementLocator, elementAttributeType.getValue(), expectedValue, ValidationComparisonType.EQUALS,
				ValidationType.POSITIVE, customLogMessage);
	}
	...
	public static void assertElementAttribute(WebDriver driver, By elementLocator, String elementAttribute,
		...
		ValidationHelper.validateElementAttribute(ValidationHelper.ValidationCategory.HARD_ASSERT, driver,
				elementLocator, elementAttribute, expectedValue, ValidationComparisonType.EQUALS,
				ValidationType.POSITIVE, customLogMessage);
	}
	...
	public static void assertElementCSSProperty(WebDriver driver, By elementLocator, String propertyName,
			String expectedValue, String... customLogMessage) {
		ValidationHelper.validateElementCSSProperty(ValidationHelper.ValidationCategory.HARD_ASSERT, driver,
				elementLocator, propertyName, expectedValue, ValidationComparisonType.EQUALS, ValidationType.POSITIVE,
				customLogMessage);
	}
	...
	/**
	 * Asserts browser attribute equals expectedValue. Supports CurrentUrl,
	...
	public static void assertBrowserAttribute(WebDriver driver, String browserAttribute, String expectedValue,
			String... customLogMessage) {
		ValidationHelper.validateBrowserAttribute(ValidationHelper.ValidationCategory.HARD_ASSERT, driver,
				browserAttribute, expectedValue, ValidationComparisonType.EQUALS, ValidationType.POSITIVE,
				customLogMessage);
	}
	...
	public static void assertBrowserAttribute(WebDriver driver, String browserAttribute, String expectedValue,
			AssertionComparisonType assertionComparisonType, AssertionType assertionType, String... customLogMessage) {
		ValidationHelper.validateBrowserAttribute(ValidationHelper.ValidationCategory.HARD_ASSERT, driver,
				browserAttribute, expectedValue, ValidationComparisonType.valueOf(assertionComparisonType.toString()),
				ValidationType.valueOf(assertionType.toString()), customLogMessage);
	}
	 ...
	 *                             in the execution report
	 */
	public static void assertBrowserAttribute(WebDriver driver, BrowserAttributeType browserAttributeType,
			String expectedValue, String... customLogMessage) {
		ValidationHelper.validateBrowserAttribute(ValidationHelper.ValidationCategory.HARD_ASSERT, driver,
				browserAttributeType.getValue(), expectedValue, ValidationComparisonType.EQUALS,
				ValidationType.POSITIVE, customLogMessage);
	}
	...
	public static void assertComparativeRelation(Number expectedValue, Number actualValue,
		...
		ValidationHelper.validateComparativeRelation(ValidationHelper.ValidationCategory.HARD_ASSERT, expectedValue,
	 ...
	 *                         the execution report
	 */
	public static void assertFileExists(String fileFolderName, String fileName, String... customLogMessage) {
		ValidationHelper.validateFileExists(ValidationHelper.ValidationCategory.HARD_ASSERT, fileFolderName, fileName,
				1, ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * Asserts that a certain file exists. Attempts to find the file for the desired
	 * NumberOfRetries.
	 *
	 * @param fileFolderName   The location of the folder that contains the target
	 *                         file, relative to the project's root folder, ending
	...
	public static void assertFileExists(String fileFolderName, String fileName, int numberOfRetries,
			String... customLogMessage) {
		ValidationHelper.validateFileExists(ValidationHelper.ValidationCategory.HARD_ASSERT, fileFolderName, fileName,
				numberOfRetries, ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * Asserts that a certain file exists if AssertionType is POSITIVE, or doesn't
	 * exist if AssertionType is NEGATIVE. Attempts to find the file for the desired
	 * NumberOfRetries.
	 *
	 * @param fileFolderName   The location of the folder that contains the target
	 *                         file, relative to the project's root folder, ending
	...
	public static void assertFileExists(String fileFolderName, String fileName, int numberOfRetries,
		...
		ValidationHelper.validateFileExists(ValidationHelper.ValidationCategory.HARD_ASSERT, fileFolderName, fileName,
				numberOfRetries, ValidationType.valueOf(assertionType.toString()), customLogMessage);
	}
	...
	public static void assertTrue(Boolean conditionalStatement, String... customLogMessage) {
		ValidationHelper.validateTrue(ValidationHelper.ValidationCategory.HARD_ASSERT, conditionalStatement,
				ValidationType.POSITIVE, customLogMessage);
	}
	...
	/**
	 * Asserts that the API Response object matches the expected referenceJsonFile.
	 *
	...
	public static void assertJSONFileContent(Response response, String referenceJsonFilePath,
			String... customLogMessage) {
		ValidationHelper.validateJSONFileContent(ValidationHelper.ValidationCategory.HARD_ASSERT, response,
				referenceJsonFilePath, ComparisonType.EQUALS, "", ValidationType.POSITIVE, customLogMessage);
	}
	...
	public static void assertJSONFileContent(Response response, String referenceJsonFilePath,
		...
		ValidationHelper.validateJSONFileContent(ValidationHelper.ValidationCategory.HARD_ASSERT, response,
				referenceJsonFilePath, comparisonType, "", ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * Asserts that the API Response object matches the expected referenceJsonFile
	 * if AssertionType is POSITIVE, or doesn't match it if AssertionType is
	 * NEGATIVE.
	 *
	 * @param response              the full response object returned by
	 *                              performRequest method.
	...
	public static void assertJSONFileContent(Response response, String referenceJsonFilePath,
		...
		ValidationHelper.validateJSONFileContent(ValidationHelper.ValidationCategory.HARD_ASSERT, response,
				referenceJsonFilePath, comparisonType, "", ValidationType.valueOf(assertionType.toString()),
				customLogMessage);
	}
	...
	public static void assertJSONFileContent(Response response, String referenceJsonFilePath,
		...
		ValidationHelper.validateJSONFileContent(ValidationHelper.ValidationCategory.HARD_ASSERT, response,
				referenceJsonFilePath, comparisonType, jsonPathToTargetArray, ValidationType.POSITIVE,
				customLogMessage);
	}
	...
	/**
	 * Asserts that the current image of the target element matches the expected
	 ...
	 *                         the execution report
	 */
	public static void assertElementMatches(WebDriver driver, By elementLocator, String... customLogMessage) {
		ValidationHelper.validateElementMatches(ValidationHelper.ValidationCategory.HARD_ASSERT, driver, elementLocator,
				ValidationHelper.VisualValidationEngine.EXACT_OPENCV, ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * Asserts that the current image of the target element matches the expected
	 * reference image if AssertionType is POSITIVE, or doesn't match it if
	 * AssertionType is NEGATIVE. Uses OpenCV natively.
	 *
	 * @param driver           the current instance of Selenium webdriver
	 * @param elementLocator   the locator of the webElement under test (By xpath,
	 *                         id, selector, name ...etc)
	...
	public static void assertElementMatches(WebDriver driver, By elementLocator, AssertionType assertionType,
			String... customLogMessage) {
		ValidationHelper.validateElementMatches(ValidationHelper.ValidationCategory.HARD_ASSERT, driver, elementLocator,
				ValidationHelper.VisualValidationEngine.EXACT_OPENCV, ValidationType.valueOf(assertionType.toString()),
				customLogMessage);
	}
	...
	public static void assertElementMatches(WebDriver driver, By elementLocator,
			VisualValidationEngine visualValidationEngine, String... customLogMessage) {
		ValidationHelper.validateElementMatches(ValidationHelper.ValidationCategory.HARD_ASSERT, driver, elementLocator,
				ValidationHelper.VisualValidationEngine.valueOf(visualValidationEngine.name()), ValidationType.POSITIVE,
				customLogMessage);
	}

	/**
	 * Asserts that the current image of the target element matches the expected
	 * reference image using the desired VisualValidationEngine if AssertionType is
	 * POSITIVE, or doesn't match it if AssertionType is NEGATIVE. Supports OpenCV
	 * natively, and Applitools Eyes. To use Eyes you need to configure your
	 * applitoolsApiKey in the path.properties file
	 *
	 * @param driver                 the current instance of Selenium webdriver
	 ...
	 */
	public static void assertElementMatches(WebDriver driver, By elementLocator,
			VisualValidationEngine visualValidationEngine, AssertionType assertionType, String... customLogMessage) {
		ValidationHelper.validateElementMatches(ValidationHelper.ValidationCategory.HARD_ASSERT, driver, elementLocator,
