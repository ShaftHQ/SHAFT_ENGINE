...
public class Verifications {
	...
	public static void verifyEquals(Object expectedValue, Object actualValue, String... customLogMessage) {
		ValidationHelper.validateEquals(ValidationHelper.ValidationCategory.SOFT_ASSERT, expectedValue, actualValue,
				ValidationHelper.ValidationComparisonType.EQUALS, ValidationHelper.ValidationType.POSITIVE,
				customLogMessage);
	}

	/**
	 * verifies that two objects are equal if verificationType is POSITIVE, or not
	 ...
	 * @param actualValue                the actual value (calculated data) of this
	 *                                   verification
	 * @param verificationComparisonType verificationComparisonType.EQUALS,
	 *                                   CONTAINS, MATCHES, CASE_INSENSITIVE
	...
	public static void verifyEquals(Object expectedValue, Object actualValue,
			Verifications.VerificationComparisonType verificationComparisonType,
	...
	public static void verifyNull(Object object, String... customLogMessage) {
		ValidationHelper.validateNull(ValidationHelper.ValidationCategory.SOFT_ASSERT, object,
				ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * verifies that the object is null if verificationType is POSITIVE, or is not
	 * null if verificationType is NEGATIVE.
	 *
	 * @param object           the object under test
	 * @param verificationType verificationType.POSITIVE, NEGATIVE
	 * @param customLogMessage a custom message that will appended to this step in
	 *                         the execution report
	 */
	public static void verifyNull(Object object, Verifications.VerificationType verificationType,
	...
	public static void verifyElementExists(WebDriver driver, By elementLocator, String... customLogMessage) {
		ValidationHelper.validateElementExists(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver, elementLocator,
				ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * verifies that the webElement found using the provided driver and locator
	 * exists if verificationType is POSITIVE, or does not exist if verificationType
	 * is NEGATIVE.
	 *
	 * @param driver           the current instance of Selenium webdriver
	 * @param elementLocator   the locator of the webElement under test (By xpath,
	 ...
	 *                         the execution report
	 */
	public static void verifyElementExists(WebDriver driver, By elementLocator,
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateElementExists(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver, elementLocator,
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	}
	 ...
	 * @param elementAttributeType the desired attribute type of the webElement
	 *                             under test
	 * @param expectedValue        the expected value (test data) of this
	 *                             verification
	 * @param customLogMessage     a custom message that will appended to this step
	 *                             in the execution report
	 */
	public static void verifyElementAttribute(WebDriver driver, By elementLocator,
			ElementAttributeType elementAttributeType, String expectedValue, String... customLogMessage) {
		ValidationHelper.validateElementAttribute(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver,
				elementLocator, elementAttributeType.getValue(), expectedValue,
				ValidationHelper.ValidationComparisonType.EQUALS, ValidationHelper.ValidationType.POSITIVE,
				customLogMessage);
	}
	...
	public static void verifyElementAttribute(WebDriver driver, By elementLocator, String elementAttribute,
		...
		ValidationHelper.validateElementAttribute(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver,
				elementLocator, elementAttribute, expectedValue, ValidationHelper.ValidationComparisonType.EQUALS,
				ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}
	 ...
	 * @param elementAttributeType       the desired attribute type of the
	 ...
	 */
	public static void verifyElementAttribute(WebDriver driver, By elementLocator,
			ElementAttributeType elementAttributeType, String expectedValue,
			Verifications.VerificationComparisonType verificationComparisonType,
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateElementAttribute(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver,
				elementLocator, elementAttributeType.getValue(), expectedValue,
	 ...
	 */
	public static void verifyElementAttribute(WebDriver driver, By elementLocator, String elementAttribute,
			String expectedValue, Verifications.VerificationComparisonType verificationComparisonType,
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateElementAttribute(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver,
				elementLocator, elementAttribute, expectedValue,
				ValidationHelper.ValidationComparisonType.valueOf(verificationComparisonType.toString()),
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	}
	...
	public static void verifyElementCSSProperty(WebDriver driver, By elementLocator, String propertyName,
			String expectedValue, String... customLogMessage) {
		ValidationHelper.validateElementCSSProperty(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver,
				elementLocator, propertyName, expectedValue, ValidationHelper.ValidationComparisonType.EQUALS,
				ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}
	...
	public static void verifyElementCSSProperty(WebDriver driver, By elementLocator, String propertyName,
			...
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateElementCSSProperty(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver,
				elementLocator, propertyName, expectedValue,
				ValidationHelper.ValidationComparisonType.valueOf(verificationComparisonType.toString()),
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	}

	/**
	 * verifies browser attribute equals expectedValue. Supports CurrentUrl,
	...
	public static void verifyBrowserAttribute(WebDriver driver, String browserAttribute, String expectedValue,
			String... customLogMessage) {
		ValidationHelper.validateBrowserAttribute(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver,
				browserAttribute, expectedValue, ValidationHelper.ValidationComparisonType.EQUALS,
				ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * verifies browser attribute equals expectedValue if verificationType is
	 * POSITIVE, or does not equal expectedValue if verificationType is NEGATIVE.
	 * Supports CurrentUrl, PageSource, Title, WindowHandle, WindowPosition,
	 * WindowSize
	 *
	 * @param driver                     the current instance of Selenium webdriver
	...
	public static void verifyBrowserAttribute(WebDriver driver, String browserAttribute, String expectedValue,
			...
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateBrowserAttribute(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver,
				browserAttribute, expectedValue,
				ValidationHelper.ValidationComparisonType.valueOf(verificationComparisonType.toString()),
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	}
	 ...
	 *                             in the execution report
	 */
	public static void verifyBrowserAttribute(WebDriver driver, BrowserAttributeType browserAttributeType,
			String expectedValue, String... customLogMessage) {
		ValidationHelper.validateBrowserAttribute(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver,
				browserAttributeType.getValue(), expectedValue, ValidationHelper.ValidationComparisonType.EQUALS,
				ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}
	 ...
	 *
	 * @param driver                     the current instance of Selenium webdriver
	 * @param browserAttributeType       the desired attribute type of the browser
	 *                                   window under test
	 * @param expectedValue              the expected value (test data) of this
	 *                                   verification
	 * @param verificationComparisonType verificationComparisonType.EQUALS,
	...
	public static void verifyBrowserAttribute(WebDriver driver, BrowserAttributeType browserAttributeType,
			...
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateBrowserAttribute(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver,
				browserAttributeType.getValue(), expectedValue,
				ValidationHelper.ValidationComparisonType.valueOf(verificationComparisonType.toString()),
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	}
	...
	public static void verifyComparativeRelation(Number expectedValue, Number actualValue,
		...
		ValidationHelper.validateComparativeRelation(ValidationHelper.ValidationCategory.SOFT_ASSERT, expectedValue,
				actualValue, ValidationHelper.ComparativeRelationType.valueOf(comparativeRelationType.toString()),
				ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}
	 ...
	 */
	public static void verifyComparativeRelation(Number expectedValue, Number actualValue,
			Verifications.ComparativeRelationType comparativeRelationType,
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateComparativeRelation(ValidationHelper.ValidationCategory.SOFT_ASSERT, expectedValue,
				actualValue, ValidationHelper.ComparativeRelationType.valueOf(comparativeRelationType.toString()),
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	 ...
	 *                         the execution report
	 */
	public static void verifyFileExists(String fileFolderName, String fileName, String... customLogMessage) {
		ValidationHelper.validateFileExists(ValidationHelper.ValidationCategory.SOFT_ASSERT, fileFolderName, fileName,
				1, ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * verifies that a certain file exists. Attempts to find the file for the
	 * desired NumberOfRetries.
	 *
	 * @param fileFolderName   The location of the folder that contains the target
	 *                         file, relative to the project's root folder, ending
	 *                         with a /
	...
	public static void verifyFileExists(String fileFolderName, String fileName, int numberOfRetries,
			String... customLogMessage) {
		ValidationHelper.validateFileExists(ValidationHelper.ValidationCategory.SOFT_ASSERT, fileFolderName, fileName,
				numberOfRetries, ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * verifies that a certain file exists if verificationType is POSITIVE, or
	 * doesn't exist if verificationType is NEGATIVE. Attempts to find the file for
	 * the desired NumberOfRetries.
	 *
	 * @param fileFolderName   The location of the folder that contains the target
	 *                         file, relative to the project's root folder, ending
	 *                         with a /
	...
	public static void verifyFileExists(String fileFolderName, String fileName, int numberOfRetries,
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateFileExists(ValidationHelper.ValidationCategory.SOFT_ASSERT, fileFolderName, fileName,
				numberOfRetries, ValidationHelper.ValidationType.valueOf(verificationType.toString()),
				customLogMessage);
	}
	...
	public static void verifyTrue(Boolean conditionalStatement, String... customLogMessage) {
		ValidationHelper.validateTrue(ValidationHelper.ValidationCategory.SOFT_ASSERT, conditionalStatement,
				ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}
	 ...
	 *                             in the execution report
	 */
	public static void verifyTrue(Boolean conditionalStatement, Verifications.VerificationType verificationType,
			String... customLogMessage) {
		ValidationHelper.validateTrue(ValidationHelper.ValidationCategory.SOFT_ASSERT, conditionalStatement,
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	}
	...
	/**
	 * verifies that the API Response object matches the expected referenceJsonFile.
	 *
	...
	public static void verifyJSONFileContent(Response response, String referenceJsonFilePath,
			String... customLogMessage) {
		ValidationHelper.validateJSONFileContent(ValidationHelper.ValidationCategory.SOFT_ASSERT, response,
				referenceJsonFilePath, RestActions.ComparisonType.EQUALS, "", ValidationHelper.ValidationType.POSITIVE,
				customLogMessage);
	}
	...
	public static void verifyJSONFileContent(Response response, String referenceJsonFilePath,
		...
		ValidationHelper.validateJSONFileContent(ValidationHelper.ValidationCategory.SOFT_ASSERT, response,
				referenceJsonFilePath, comparisonType, "", ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * verifies that the API Response object matches the expected referenceJsonFile
	 * if verificationType is POSITIVE, or doesn't match it if verificationType is
	 * NEGATIVE.
	 *
	 * @param response              the full response object returned by
	 *                              performRequest method.
	 ...
	 */
	public static void verifyJSONFileContent(Response response, String referenceJsonFilePath,
			RestActions.ComparisonType comparisonType, Verifications.VerificationType verificationType,
			String... customLogMessage) {
		ValidationHelper.validateJSONFileContent(ValidationHelper.ValidationCategory.SOFT_ASSERT, response,
				referenceJsonFilePath, comparisonType, "",
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	}
	...
	public static void verifyJSONFileContent(Response response, String referenceJsonFilePath,
		...
		ValidationHelper.validateJSONFileContent(ValidationHelper.ValidationCategory.SOFT_ASSERT, response,
				referenceJsonFilePath, comparisonType, jsonPathToTargetArray, ValidationHelper.ValidationType.POSITIVE,
				customLogMessage);
	}
	...
	public static void verifyJSONFileContent(Response response, String referenceJsonFilePath,
			...
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateJSONFileContent(ValidationHelper.ValidationCategory.SOFT_ASSERT, response,
				referenceJsonFilePath, comparisonType, jsonPathToTargetArray,
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	}

	/**
	 * verifies that the current image of the target element matches the expected
	 * reference image. Uses OpenCV natively.
	 *
	 * @param driver           the current instance of Selenium webdriver
	 * @param elementLocator   the locator of the webElement under test (By xpath,
	 *                         id, selector, name ...etc)
	 ...
	 *                         the execution report
	 */
	public static void verifyElementMatches(WebDriver driver, By elementLocator, String... customLogMessage) {
		ValidationHelper.validateElementMatches(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver, elementLocator,
				ValidationHelper.VisualValidationEngine.EXACT_OPENCV, ValidationHelper.ValidationType.POSITIVE,
				customLogMessage);
	}

	/**
	 * verifies that the current image of the target element matches the expected
	 * reference image if verificationType is POSITIVE, or doesn't match it if
	 * verificationType is NEGATIVE. Uses OpenCV natively.
	 *
	 * @param driver           the current instance of Selenium webdriver
	 * @param elementLocator   the locator of the webElement under test (By xpath,
	 *                         id, selector, name ...etc)
	...
	public static void verifyElementMatches(WebDriver driver, By elementLocator,
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateElementMatches(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver, elementLocator,
				ValidationHelper.VisualValidationEngine.EXACT_OPENCV,
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	}

	/**
	 * verifies that the current image of the target element matches the expected
	 * reference image using the desired VisualValidationEngine. Supports OpenCV
	 * natively, and Applitools Eyes. To use Eyes you need to configure your
	 * applitoolsApiKey in the path.properties file
	 *
	 * @param driver                 the current instance of Selenium webdriver
	 * @param elementLocator         the locator of the webElement under test (By
	 *                               xpath, id, selector, name ...etc)
	 * @param visualValidationEngine VisualValidationEngine.EXACT_OPENCV,
	 *                               EXACT_EYES, STRICT_EYES, CONTENT_EYES,
	 *                               LAYOUT_EYES
	 * @param customLogMessage       a custom message that will appended to this
	 *                               step in * the execution report
	 */
	public static void verifyElementMatches(WebDriver driver, By elementLocator,
			Verifications.VisualValidationEngine visualValidationEngine, String... customLogMessage) {
		ValidationHelper.validateElementMatches(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver, elementLocator,
				ValidationHelper.VisualValidationEngine.valueOf(visualValidationEngine.name()),
				ValidationHelper.ValidationType.POSITIVE, customLogMessage);
	}

	/**
	 * verifies that the current image of the target element matches the expected
	 * reference image using the desired VisualValidationEngine if verificationType
	 * is POSITIVE, or doesn't match it if verificationType is NEGATIVE. Supports
	 * OpenCV natively, and Applitools Eyes. To use Eyes you need to configure your
	 * applitoolsApiKey in the path.properties file
	 *
	 * @param driver                 the current instance of Selenium webdriver
	 * @param elementLocator         the locator of the webElement under test (By
	 ...
	 */
	public static void verifyElementMatches(WebDriver driver, By elementLocator,
			Verifications.VisualValidationEngine visualValidationEngine,
			Verifications.VerificationType verificationType, String... customLogMessage) {
		ValidationHelper.validateElementMatches(ValidationHelper.ValidationCategory.SOFT_ASSERT, driver, elementLocator,
				ValidationHelper.VisualValidationEngine.valueOf(visualValidationEngine.name()),
				ValidationHelper.ValidationType.valueOf(verificationType.toString()), customLogMessage);
	...
	public enum VisualValidationEngine {
		EXACT_OPENCV, EXACT_EYES, STRICT_EYES, CONTENT_EYES, LAYOUT_EYES
	}
	...
	public enum BrowserAttributeType {
		CURRENT_URL("currenturl"), PAGE_SOURCE("pagesource"), TITLE("title"), WINDOW_HANDLE("windowhandle"),
		WINDOW_POSITION("windowposition"), WINDOW_SIZE("windowsize");
