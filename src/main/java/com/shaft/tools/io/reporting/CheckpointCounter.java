...
public class CheckpointCounter {
    ...
    public static void attach() {
        ...
        //calculate percentage of passed or failed checkpoints
        //multiply percentage by 360 and append it to the style tag to draw the pie chart
        var passedTestsPercentage = passedCheckpoints * 360d / checkpoints.size();
        htmlBuilder.append(passedTestsPercentage);
        ...
        htmlBuilder.append("""
                ...
                <br><h3><b>Total</b>:&nbsp""");

        htmlBuilder.append(checkpoints.size());
        htmlBuilder.append("""
                &nbsp|&nbsp<font style="color:MediumSeaGreen;"><b>Passed:</b>&nbsp""");
        htmlBuilder.append(passedCheckpoints);

        htmlBuilder.append("""
                </font>&nbsp|&nbsp<font style="color:Tomato;"><b>Failed:</b>&nbsp""");
        htmlBuilder.append(failedCheckpoints);
        ...
        checkpoints.entrySet().stream()
                .forEach(entry -> htmlBuilder.append(String.format("<tr class=\"row100 body\"><td class=\"cell100 column1\">%d</td><td class=\"cell100 column2\">%s</td><td class=\"cell100 column3\">%s</td><td class=\"cell100 column4\">%s</td></tr>", entry.getKey(), entry.getValue().get(0), entry.getValue().get(1), entry.getValue().get(2))));
