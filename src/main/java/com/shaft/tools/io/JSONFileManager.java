...
public class JSONFileManager {
	...
	public JSONFileManager(String jsonFilePath) {
		...
		try {
			...
			// unreachable code because if the file was not found then the reader would have
			// failed at a previous step
		}
	...
	/**
	 * Used internally to remove x. from the beginning of any jsonpath. This matches
	 * the generated jsonpaths by online helper tools such as
	...
	/**
	 * Reads the string value at the desired jsonpath within the target test data
	 * file
	 *
	 * @param jsonPath the desired jsonpath that points to the needed test data, it
	 *                 can be written manually or generated using helper tools such
	 *                 as https://jsonpathfinder.com/
