...
Querying an existing graph ("what calls X?", `/graphify path`, `/graphify explain`): `references/query.md`. Building a graph for any corpus: `references/full-pipeline.md`.
