...
This object was renamed once before it landed. Its first title began "When a matcher strips a token, a" + the three-letter verb meaning to enquire, and the slug that produced tripped the Memory CLI's unanchored openai_api_key rule (#4005): any hyphenated word ending in those two letters, followed by 20 or more word characters, reads as a key.