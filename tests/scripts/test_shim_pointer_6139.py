...
class ShimPointerTest(unittest.TestCase):
    def test_pointer_catalog_reexport_and_vendor_icm_path(self):
        ...
        self.assertIn("Pointer shim", router)
        self.assertIn("`vendor/icm-architect/skills/icm-architect/SKILL.md`", router)
        self.assertNotIn("references/icm-architect.md) |", router)
