...
RECOVERED_PUBLIC_FILE_COUNT = 171
RECOVERED_PUBLIC_PATHS_SHA256 = (
    "44d553133fd4452524f469b4b9385fc374af55a88fbc842463131f60cfc1092a"
)
...
def public_recovery_inventory() -> tuple[str, ...]:
    return tuple(
        sorted(
            ...
            if path.is_file() and "__pycache__" not in path.relative_to(CHAOS_GAUGE).parts
        )
    )
